package com.example.cobaapi.api.adapter
...
class ProductAdapter (private val onClick: (Product)->Unit):
    ...
    class ProductViewHolder(itemView: View, val onClick: (Product) -> Unit):
        ...
        private  val brand: TextView = itemView.requireViewById(R.id.brand)
        private val price: TextView = itemView.requireViewById(R.id.price)
